...
<body id="body-pd">
    ...
    <div class="container box_cont">
	    <p>Vous avez <span>${sessionScope.listeProdElem.size()}</span> elements </p>
	    <jsp:useBean id="daoElement" class="AccesBD.DAOElement"/>
	   <div>
	   <c:forEach items="${sessionScope.listeProdElem}" var="element">
	   
		   <c:if test="${!daoElement.selectElm(element)}">
			   <div>
		   ...
		   <c:if test="${daoElement.selectElm(element)}">
			   ...
			   <button style='background : #0db290'>
